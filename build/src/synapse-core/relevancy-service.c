/* relevancy-service.c generated by valac 0.50.1, the Vala compiler
...
void synapse_relevancy_backend_application_launched (SynapseRelevancyBackend* self,
                                                     GAppInfo* app_info);
static GType synapse_relevancy_backend_get_type_once (void);
...
static GType synapse_relevancy_service_get_type_once (void);
...
static GType
synapse_relevancy_backend_get_type_once (void)
{
...
synapse_relevancy_backend_get_type (void)
{
	...
	if (g_once_init_enter (&synapse_relevancy_backend_type_id__volatile)) {
		GType synapse_relevancy_backend_type_id;
		synapse_relevancy_backend_type_id = synapse_relevancy_backend_get_type_once ();
...
static GType
synapse_relevancy_service_get_type_once (void)
{
	...
	SynapseRelevancyService_private_offset = g_type_add_instance_private (synapse_relevancy_service_type_id, sizeof (SynapseRelevancyServicePrivate));
...
synapse_relevancy_service_get_type (void)
{
	...
	if (g_once_init_enter (&synapse_relevancy_service_type_id__volatile)) {
		GType synapse_relevancy_service_type_id;
		synapse_relevancy_service_type_id = synapse_relevancy_service_get_type_once ();
